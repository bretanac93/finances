...
class ChildAccount
{
     ...
     * Add openingBalance
     *
     * @param \AppBundle\Entity\OpeningBalance $openingBalance
     *
     * @return ChildAccount
     */
    public function addOpeningBalance(\AppBundle\Entity\OpeningBalance $openingBalance)
    {
        $this->opening_balances[] = $openingBalance;

        return $this;
    }

    /**
     * Remove openingBalance
     *
     * @param \AppBundle\Entity\OpeningBalance $openingBalance
     */
    public function removeOpeningBalance(\AppBundle\Entity\OpeningBalance $openingBalance)
    {
        $this->opening_balances->removeElement($openingBalance);
    }
